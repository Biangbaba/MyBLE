package com.biang.blemodule.utils;
 ...
 *
 * http://blog.csdn.net/finddreams/article/details/45569089
 */
public class LogUtil {

    public static String customTagPrefix = "zrkd"; // 自定义Tag的前缀，可以是作者名
